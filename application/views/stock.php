      ...
      <div class="col-md-6">
        <div class="panel panel-headline">
          <div class="panel-heading">
            <h3 class="panel-title">Laporan Persediaan</h3>
          ...
          <div class="panel-body">
           <div class="row">
            ...
            <div class="box-body">
              <hr>
              <div class="text-right">
                <h3> PERSEDIAAN : <span id="total"></span></h3>
              </div>
              <hr>
...
<script>
  ...
  $(document).ready(function() {
    $('#filter_product').load("<?php echo site_url('inventory/getProduct'); ?>");
    $('#filter_location').load("<?php echo site_url('inventory/getLocation'); ?>");
  ...
  function load_table(){
    table = $('#table').DataTable({
      "footerCallback": function ( row, data, start, end, display ) {
        ...
        $( api.column( 4 ).footer() ).text(formatNumber(jml));
        $( api.column( 5 ).footer() ).text(formatNumber(total));
      },
      "destroy": "true",
      "order": [],
      "dom" : 'Bfrtip',
      ...
      "ajax": {
        "url": "<?php echo site_url('inventory/load_data')?>",
        "type": "POST",
        "data": function ( data ) {
  ...
  function getTotal(){
    $.ajax({
      url : "<?php echo site_url('inventory/getTotal')?>/",
      type: "POST",
      dataType: "JSON",
      data: {
